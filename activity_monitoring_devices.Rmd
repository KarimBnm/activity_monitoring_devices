...
```{r}
stepsperinterval_mean[which(stepsperinterval_mean$mean_steps_per_interval==max(stepsperinterval_mean$mean_steps_per_interval)), "interval"]
```
...
summarize(stepsperday_withoutNA, 
...
head(stepsperinterval_mean_withweekfactor)
